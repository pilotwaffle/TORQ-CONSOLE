#!/usr/bin/env python3
"""
Simple test script to validate RL learning in Prince Flowers Agent
"""
...
async def test_rl_learning():
    ...
    if prediction:
        print(f"  SUCCESS: Agent predicted correction: {prediction}")
    else:
        print("  WARNING: No correction predicted")
    ...
    if correction:
        print(f"  SUCCESS: Automatic correction applied: {correction}")
    else:
        print("  WARNING: No automatic correction available")
