#!/bin/bash
# Integration script for final 3 tools into Prince Flowers

echo "========================================="
echo "TORQ Console - Final Tools Integration"
echo "Adding Terminal Commands, MCP Client, Multi-Tool Composition"
echo "========================================="

# Backup original file
echo "Creating backup..."
cp torq_console/agents/torq_prince_flowers.py torq_console/agents/torq_prince_flowers.py.backup
echo "Backup created: torq_prince_flowers.py.backup"

# Since sed behaves differently on Windows (Git Bash), let's create a simpler approach
# We'll create a Python script to do the integration

cat > integrate_tools_real.py << 'EOFPYTHON'
#!/usr/bin/env python3
"""
...
python3 integrate_tools_real.py || python integrate_tools_real.py || py integrate_tools_real.py

echo ""
echo "========================================="
echo "Integration Phase 1 & 2 Complete!"
echo "========================================="
echo "Steps completed:"
echo "1. Imports added"
echo "2. Registry entries added"
echo ""
echo "Manual steps still needed:"
echo "3. Add execute methods (see patch file)"
echo "4. Add routing logic (see patch file)"
echo ""
echo "See 'add_final_tools_patch.txt' for full details"
